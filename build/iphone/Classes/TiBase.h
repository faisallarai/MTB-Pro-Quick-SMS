...
// in simulator we redefine to format for MTBProQuickSMS Developer console
...
{\
	NSString * exceptionName = [@"org.mtbproquicksms." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mtbproquicksms";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIMTBProQuickSMSNativeItemNone = -1, 
	UIMTBProQuickSMSNativeItemSpinner = -2,
	UIMTBProQuickSMSNativeItemProgressBar = -3,
	
	UIMTBProQuickSMSNativeItemSlider = -4,
	UIMTBProQuickSMSNativeItemSwitch = -5,
	UIMTBProQuickSMSNativeItemMultiButton = -6,
	UIMTBProQuickSMSNativeItemSegmented = -7,
	
	UIMTBProQuickSMSNativeItemTextView = -8,
	UIMTBProQuickSMSNativeItemTextField = -9,
	UIMTBProQuickSMSNativeItemSearchBar = -10,
	
	UIMTBProQuickSMSNativeItemPicker = -11,
	UIMTBProQuickSMSNativeItemDatePicker = -12,
	
	UIMTBProQuickSMSNativeItemInfoLight = -13,
	UIMTBProQuickSMSNativeItemInfoDark = -14,
	
	UIMTBProQuickSMSNativeItemDisclosure = -15,
	
	UIMTBProQuickSMSNativeItemContactAdd = -16
};
