...
-(id)call:(NSArray*)args
{
	...
	{
		@throw [NSException exceptionWithName:@"org.mtbproquicksms.kroll" reason:[NSString stringWithFormat:@"invalid method '%@'",NSStringFromSelector(selector)] userInfo:nil];
	}
	NSInvocation *invoker = [NSInvocation invocationWithMethodSignature:methodSignature];
